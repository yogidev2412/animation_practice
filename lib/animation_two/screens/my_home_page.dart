...
import '../model/scroll_list_model.dart';
...
class _MyHomePagesState extends State<MyHomePages> {
  ...
  void initState() {
    ...
    controller.addListener(() {
      print("offset ${controller.offset / 120}");
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Opacity(
                      ...
                      child: Transform(
                        ...
                        alignment: Alignment.topCenter,
                        child: Align(heightFactor: 0.7, child: myItems[index]),
                      ),
                    );
                  },
                ),
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Image.asset(items.image, fit: BoxFit.cover),
            ],
          ),
        ),
      );
