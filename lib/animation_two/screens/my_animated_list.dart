...
import '../model/animated_list_model.dart';
...
class _MyAnimatedListState extends State<MyAnimatedList>
  ...
  Padding displaySelectedUser({required User user, index, animation}) {
    return Padding(
  ...
  GestureDetector displayUser({required User user, index, animation}) {
